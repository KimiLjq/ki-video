...
//    private String serverUrl;
    ...
    //返回图片大小是否符合要求
    public boolean checkFileSize(MultipartFile file) throws OutputException {
        if (file.getSize() / 1024 / 1024 > 5) throw new OutputException(RestCode.DATA_FORMAT_EXCEPTION, "文件大小过大，最大为5M");
        return true;
    }
    ...
    public String[] newFileUrl(String sonFolder, MultipartFile file) {
        ...
        String localFile = "/root/kimi/nginx/static" + "/" + sonFolder + "/" + date + "/" + fileName;
        String httpFile = "http://172.16.75.32:8080" + "/file/" + dynamicUrl;
